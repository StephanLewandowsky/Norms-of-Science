%Add stuff about how norms are not necessarily fully realistic as per Naomi's book
%Send to Chris Mooney

%checklist 7 Feb 2021
% put R code for Study 2 at https://git.io/fpEYo
...
\acknowledgements{Preparation of this paper was facilitated by a  
 Humboldt
Award from the Alexander von Humboldt Foundation to the first
author. This project has also received funding from the European Union’s 
Horizon 2020 research and innovation programme under grant agreement No 964728 (JITSUVAX).
...
Our first study therefore included a number
of different scientific constructs in order to establish the breadth
of involvement of nationalism in the rejection of science. 
In particular, we probed attitudes towards climate science, where
we expected nationalism to be implicated
because of the associated global governance issues. We also probed 
other scientific propositions that have no global governance 
implications (vaccinations and heritability of intelligence) where
nationalism would only be implicated indirectly, via its presumed
conflict with the norms of science.
...
%The implications of the pursuit of well-being 
%have been aptly satirized in a recent article 
%that issued a ``final warning to planet Earth'', 
%proclaiming that
%``growth must indefinitely prevail unrestricted'' \cite[p.~1]{Chapron18}.
%\todo[inline]{The Chapron et al article is so hilarious yet profound that I really want
%to cite it, although I am not sure that this works for the uninformed
%reader without more explanation.}
...
%fair in ultimatum games \cite{Proctor13} and to be 
...
%A radical interpretation of those findings has been proposed by 
%\citeA{McGregor18}, who not only rejects the idea 
%that human cognition is exceptional but 
%``entirely
%refuses to draw any distinction between cognitive and
%non-cognitive systems'' (p.~35).
...
%https://ebookcentral-proquest-com.ezproxy.library.uwa.edu.au/lib/uwa/detail.action;jsessionid=1u0trya2y6368e36tu9o1hhro?docID=5110769#goto_toc (Interesting book only available as 1-day loan)
%https://www.newscientist.com/article/mg22830511-100-time-to-rethink-what-makes-humans-special/ <--two interesting books being reviewed
%great BBC piece: http://www.bbc.co.uk/earth/story/20150706-humans-are-not-unique-or-special
%We are not unique: 
%Roberts12 (Uganda chimps, gestures)
%Warneken15: Chimps can cook (almost)
%Whiten99: Chimps have culture
%DavilaRoss15: chimps have laugh faces
%Parr06: chimp facial expressions (review)
%Brosnan03: monkeys reject unfair payment
%Plotnik06: Self-recognition in an Asian elephant
%Prior08: self-recognition in a magpie
%Watson15: immigrant chimpanzees learn local "language" (signifiers for objects)
...
%O'Brien15 <- Latent class analysis reveals three groups based on knowledge and attitudes
...
%root their views in religion rather than in mainstream science.
%Religious people require less evidence: McPhetres17
...
%based only upon the number of students in each school, 
and this support is
...
%race "science:" https://www.theguardian.com/news/2018/mar/02/the-unwelcome-revival-of-race-science
...
and endorsement of the heritability construct. 
 ...
 %Klaus review of meta analyses: https://featuredcontent.psychonomic.org/training-of-intelligence-a-question-of-intelligent-training/
% from Klaus email 23/3/18: I’ve had a brief look at these papers, and ended up reading the Sauce & M. one in more detail. As they say, none of their points are new, but they provide a useful overview of the arguments and the evidence. For the narrow purpose of our religion paper, the important thing is that genetic influences on IQ are indisputable. It does not really matter how high the h-square is, because, as Sauce & M. point out, it conflates a variety of more or less indirect causal paths from genes through (body-internal and external) environment to phenotype, and because it varies substantially with age and with SES. The estimate of Polderman matches other estimates I’m aware of for young adulthood. 
%I looked back at our survey statements of intelligence and I still think that our judgments on which of them are true and which are false, in light of current science, is defensible – although one could of course question the generality of most of them (e.g., “Twins separated shortly after birth will end up having similar intelligence even if they are reared in different familiy environments” is not true if you make the family environments extremely different) – but then, that’s inevitably so because we had to keep the items simple. 
...
the results. For illustration,
Table~\ref{tab:itemoverview} shows one representative items for
each construct used across the two studies.

\begin{table} 
%	\renewcommand\arraystretch{1}
	\caption{Sample items for all constructs used in both studies and their short names}
	\label{tab:itemoverview}
	{\setstretch{1.4}
	\begin{tabular}{p{.2\linewidth} p{.18\linewidth} p{.62\linewidth}} %tab:itemoverview
		\hline
		Construct & Item name & \multicolumn{1}{c}{Item}  \\
		\hline
		\multicolumn{3}{c}{Study 1}\\
		\hline
		Exceptionalism & \emph{HumConsc} & Humans are the only living beings who are conscious. \\
		Nationalism & \emph{Allegiance} & Every human must have an allegiance to one country and one country only. \\
		IQ Heritable & \emph{IQGen} & When people differ in intelligence, it is mostly due to differences in their genetic endowment.  \\
		Religiosity & 	\emph{RelComf} & Religion gives me a great amount of comfort and security in my life. \\
		Free market & \emph{FMMoreImp}&The preservation of the free market system is more important than localized environmental concerns.  \\
		Climate science & 	\emph{CO2causesCC} & Human CO2 emissions cause climate change. \\ 
		Vaccinations & 	\emph{VaxSafe} & I believe that vaccines are a safe and reliable way to
		help avert the spread of preventable diseases. \\	
		\hline
		\multicolumn{3}{c}{Study 2 (new constructs only)}\\
		\hline
		Norms of Science & \emph{NOR\_COM1} & Scientific findings should be available to everybody everywhere in the world
		\\
		...
		\\
		Conservatism & 	\textit{POL\_CONS1} &	People are better off in a free market economy \\
		Social Dominance Orientation &		\textit{SDO1} &	An ideal society requires some groups to be on top and others to be on the bottom \\
...
RMSEA=\Sexpr{round(twofacIQgof["rmsea"],3)} (90\% CI:
 \Sexpr{round(twofacIQgof["rmsea.ci.lower"],3)}--\Sexpr{round(twofacIQgof["rmsea.ci.upper"],3)}).\footnote{ 
Evaluating the fit of a structural equation model involves is a complex judgment based on a number of
available fit indices \cite{Hu99}. The $\chi^2$ statistic compares the goodness of fit between the obtained
covariance matrix and the predicted matrix derived from the model, where a significant test
indicates model \textit{misfit}. The $\chi^2$ statistic is rarely used to make decisions about fit because
for models based on more than 
400 cases, the $\chi^2$ is almost always statistically significant \cite{Kenny20}. In addition,
the value of the statistic is also affected by the magnitude of the correlations in the model, with
larger correlations giving rise to poorer fit \cite{Kenny20}. For these reasons, researchers
have focused on alternative measures of fit. We report three additional measures:
(a) The Comparative Fit Index (CFI), which is an incremental fit index that can be interpreted
in a manner analogous to $R^2$, with 0 representing complete lack of fit and 1 a perfect fit. 
Values of CFI in excess of .90 or .95 are considered to indicate a good fit \cite{Hu99}. 

(b) The Standardized Root Mean Square Residual (SRMR) which represents the standardized difference 
between observed and predicted correlations. A value of zero indicates perfect fit and values less than .08 
are generally considered a good fit \cite{Hu99}. 

(c) The Root Mean Square Error of Approximation (RMSEA) is an absolute measure of fit that
is derived from  $\chi^2$ and considers sample size and model complexity. Lower values of RMSEA denote
better fit, and conventionally a 90\% confidence interval of the estimate is reported, 
where ideally the lower value is no higher than .05 and the upper value less than .08 
\cite{Kenny20}. 
}
 Because 
...
The supplement provides further details about the single-indicator
models, including summary and fit statistics (Table~S3).
...
$p < \Sexpr{round(finalmodelgof["pvalue"]+.0001,4)}$; 
...
In summary, the first study again failed to find a notable association between left-leaning
political views and potential rejection of scientific evidence, in this case relating to 
the heritability of intelligence. The first study also provided several
glimpses into the possibility that conservative political leanings may be in
intrinsic conflict with the norms of the scientific enterprise, in particular
its universality and communism. The purpose of the next study was to solidify
those glimpses into a more direct examination of the relationship
between scientific norms and political views.
...
Table~\ref{tab:itemoverview} provides sample test items for each of those
4 norms (the complete list is in Table~S4).
We also replaced 
...
43 items to measure the attitudinal constructs (see Table~S4).
...
an 11-point scale (see Table~S4).
...
reverse scoring)
to all items for more than one construct
($N=$ \Sexpr{as.numeric(table(rowSums(keyhitters))[3])}), 
yielding a final set of \Sexpr{dim(newNorms1.5)[1]}
...
Table~S5 and Figure~S2 summarize the raw responses and show the distributions
of composite scores.
...
model. 
Because the expected relationship between political views and the norms of
science were of particular interest, we first considered the correlations
between conservatism and the 4 subscales (Table~\ref{tab:normcors}).
The table shows that greater conservatism was associated with
reduced endorsement of the norms of science overall (bottom row)
and with reduced endorsement of 3 out of 4 of the subscales.
Only skepticism appeared to be apolitical and was not 
associated with the conservatism scale. Because 
the measurement model for norms based on the 4 composites for the subscales 
fit extremely well (Table~\ref{tab:indicatormodels2}), and because
conservatism was strongly associated with reduced endorsement of
norms overall,
we do not differentiate between the subscales from here on.

\begin{table} 
	\setstretch{2}
	\caption{Correlations between conservatism and individual scientific norms in Study~2} 
	\label{tab:normcors} 
	\begin{tabular}{@{\extracolsep{2pt}} l rr rr rrr} 
		
		\thickline
		& \multicolumn{1}{c}{Conservatism}    & \multicolumn{1}{c}{Universalism}  & \multicolumn{1}{c}{Disinterestedness}  
		& \multicolumn{1}{c}{Communism}  & \multicolumn{1}{c}{Scepticism}  \\
		
		\hline 
		
		\input{_t.normcors.tex}
		
		\hline 
	\end{tabular} 
	\tabfnt{}{\textit{Note}. All correlations are significant at $p < .0001$, with the exception of Conservatism $\times$ Scepticism, for which $p > .1$. The All norms score was obtained by averaging each participant's responses across all items pertaining
	to norms. Scores for the individual norms were obtained by averaging responses within each relevant subscale.}
\end{table}


We followed a similar approach for SDO. 
We first averaged responses within pairs of
...
latent variable's single indicator (see Table~S6).
...
The model fit very well, $\chi^2(\Sexpr{fitallgof2["df"]})=\Sexpr{round(fitallgof2["chisq"],2)}$, $p = \Sexpr{round(fitallgof2["pvalue"],4)}$; 
...
(bearing in mind the exception for skepticism; see Table~\ref{tab:normcors}).
The pervasive
...
cognitive processing to interpret data in the laboratory, as opposed to 
expressing
their pre-existing attitudes in a survey, then conservatives and liberals
...
ask about a person's pre-existing view about scientific findings on a 
broad topic such as climate change or vaccinations. Those views, in turn,
have likely been formed over time based on information from the media, 
friends and family, community leaders, 
and other public sources that a person finds credible. On each of those occasions,
there is an opportunity to consider that testimony through the lens of
the norms of science. 
By contrast, in laboratory experiments where people are asked to 
draw their own conclusions from specific data, 
it appears that the propensity to distrust
science is not activated by the task at hand. 
This account is necessarily speculative but it gives
rise to several interesting empirical questions about the 
relationship between the two paradigms that can be explored
in future research, such as whether explicit reminders
about the norms of science would affect subsequent interpretation 
of the data, or conversely, whether partisan differences in
attitudes might become attenuated by prior processing of data.
...
\begin{thebibliography}{}
	...
	\begin{APACrefauthors}%
		...
		, Duncan, G\BPBI J.%
		, Buschkuehl, M.%
		\BCBL {}\ \BBA {} Jaeggi, S\BPBI M.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2015}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Improving fluid intelligence with training on working
		memory: a meta-analysis} {Improving fluid intelligence with training on
		working memory: a meta-analysis}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Psychonomic Bulletin {\&} Review}{22}{}{366--377}.
	\newblock
	\begin{APACrefDOI} \doi{10.3758/s13423-014-0699-x} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		...
		, Galvan, F\BPBI H.%
		, Wagner, G\BPBI J.%
		\BCBL {}\ \BBA {} Klein, D\BPBI J.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2011}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Longitudinal Association of {HIV} Conspiracy Beliefs
		with Sexual Risk Among Black Males Living with {HIV}} {Longitudinal
		association of {HIV} conspiracy beliefs with sexual risk among black males
		living with {HIV}}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{AIDS and Behavior}{15}{}{1180--1186}.
	\newblock
	\begin{APACrefDOI} \doi{10.1007/s10461-010-9796-7.} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Capstick, S\BPBI B.%
		\BCBT {}\ \BBA {} Pidgeon, N\BPBI F.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2014}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {What is climate change scepticism? Examination of the
		concept using a mixed methods study of the {UK} public} {What is climate
		change scepticism? examination of the concept using a mixed methods study of
		the {UK} public}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Global Environmental Change}{24}{0}{389--401}.
	\newblock
	\begin{APACrefURL}
		\url{http://www.sciencedirect.com/science/article/pii/S0959378013001477}
	\end{APACrefURL}
	\newblock
	\begin{APACrefDOI} \doi{http://dx.doi.org/10.1016/j.gloenvcha.2013.08.012}
	\end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	{\BBOQ}\APACrefatitle {Liberal Ideologies and Federal School Reform: Following
		Individualism, Meliorism, and Neutrality Through {SIG} Policy to {A}delante
		{A}lternative {S}chool} {Liberal ideologies and federal school reform:
		Following individualism, meliorism, and neutrality through {SIG} policy to
		{A}delante {A}lternative {S}chool}.{\BBCQ}
	\newblock
	...
	\APACrefYearMonthDay{2008}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Estimating the Lost Benefits of Antiretroviral Drug Use
		in {S}outh {A}frica} {Estimating the lost benefits of antiretroviral drug use
		in {S}outh {A}frica}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Journal of Acquired Immune Deficiency
		Syndrome}{49}{}{410--415}.
	\newblock
	\begin{APACrefDOI} \doi{10.1097/QAI.0b013e31818a6cd5} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Cook, J.%
		\BCBT {}\ \BBA {} Lewandowsky, S.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Rational Irrationality: {M}odeling Climate Change Belief
		Polarization Using {B}ayesian Networks} {Rational irrationality: {M}odeling
		climate change belief polarization using {B}ayesian networks}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Topics in Cognitive Science}{8}{}{160--179}.
	\newblock
	\begin{APACrefDOI} \doi{10.1111/tops.12186} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2015}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {My country or my planet? {E}xploring the influence of
		multiple place attachments and ideological beliefs upon climate change
		attitudes and opinions} {My country or my planet? {E}xploring the influence
		of multiple place attachments and ideological beliefs upon climate change
		attitudes and opinions}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Global Environmental Change}{30}{}{68 - 79}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.gloenvcha.2014.10.012} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2014}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Why do right-wing adherents engage in more animal
		exploitation and meat consumption?} {Why do right-wing adherents engage in
		more animal exploitation and meat consumption?}{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Personality and Individual Differences}{64}{}{12--17}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.paid.2014.02.002} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Dhont, K.%
		, Hodson, G.%
		\BCBL {}\ \BBA {} Leite, A\BPBI C.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Common {Ideological} {Roots} of {Speciesism} and
		{Generalized} {Ethnic} {Prejudice}: {The} {Social} {Dominance}
		{Human}–{Animal} {Relations} {Model} ({SD}-{HARM})} {Common {Ideological}
		{Roots} of {Speciesism} and {Generalized} {Ethnic} {Prejudice}: {The}
		{Social} {Dominance} {Human}–{Animal} {Relations} {Model}
		({SD}-{HARM})}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{European Journal of Personality}{30}{}{507--522}.
	\newblock
	\begin{APACrefDOI} \doi{https://doi.org/10.1002/per.2069} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Dougherty, M\BPBI R.%
		, Hamovitz, T.%
		\BCBL {}\ \BBA {} Tidwell, J\BPBI W.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Reevaluating the effectiveness of n-back training on
		transfer through the Bayesian lens: Support for the null} {Reevaluating the
		effectiveness of n-back training on transfer through the bayesian lens:
		Support for the null}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Psychonomic Bulletin {\&} Review}{23}{}{306--316}.
	\newblock
	\begin{APACrefDOI} \doi{10.3758/s13423-015-0865-9} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		...
		, Van~Liere, K\BPBI D.%
		, Mertig, A\BPBI G.%
		\BCBL {}\ \BBA {} Jones, R\BPBI E.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2000}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Measuring Endorsement of the New Ecological Paradigm:
		{A} Revised {NEP} Scale} {Measuring endorsement of the new ecological
		paradigm: {A} revised {NEP} scale}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Journal of Social Issues}{56}{}{425--442}.
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Dweck, C\BPBI S.%
		, Chiu, C\BHBI y.%
		\BCBL {}\ \BBA {} Hong, Y\BHBI y.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{1995}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Implicit theories and their role in judgments and
		reactions: A word from two perspectives} {Implicit theories and their role in
		judgments and reactions: A word from two perspectives}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Psychological inquiry}{6}{}{267--285}.
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Finlay, B\BPBI L.%
		\BCBT {}\ \BBA {} Workman, A\BPBI D.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2013}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Human exceptionalism} {Human exceptionalism}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Trends in Cognitive Sciences}{17}{}{199 -- 201}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.tics.2013.03.001} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\newblock
	{\BBOQ}\APACrefatitle {Politicization of Science in the Public Sphere: {A}
		Study of Public Trust in the {U}nited {S}tates, 1974 to 2010} {Politicization
		of science in the public sphere: {A} study of public trust in the {U}nited
		{S}tates, 1974 to 2010}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{American Sociological Review}{77}{}{167--187}.
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2017}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Can Science Explain the Human Mind? {I}ntuitive
		Judgments About the Limits of Science} {Can science explain the human mind?
		{I}ntuitive judgments about the limits of science}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Psychological Science}{}{}{}.
	\newblock
	\begin{APACrefDOI} \doi{10.1177/0956797617722609} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\newblock
	{\BBOQ}\APACrefatitle {Fake news on {T}witter during the 2016 {U.S}.
		presidential election} {Fake news on {T}witter during the 2016 {U.S}.
		presidential election}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Science}{363}{}{374--378}.
	\newblock
	\begin{APACrefDOI} \doi{10.1126/science.aau2706} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\newblock
	{\BBOQ}\APACrefatitle {Exposure to untrustworthy websites in the 2016 {U.S.}
		election} {Exposure to untrustworthy websites in the 2016 {U.S.}
		election}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Nature Human Behavior}{in press}{}{}.
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2014}{}{}.
	\newblock
	\APACrefbtitle {Do You Trust Scientists About the Environment? {N}ews Media
		Sources and Politics Affect {N}ew {H}ampshire Resident Views} {Do you trust
		scientists about the environment? {N}ews media sources and politics affect
		{N}ew {H}ampshire resident views}\ \APACbVolEdTR {}{Regional issue brief\
		\BNUM~40}.
	\newblock
	...
	\newblock
	{\BBOQ}\APACrefatitle {Genomic analysis of family data reveals additional
		genetic effects on intelligence and personality} {Genomic analysis of family
		data reveals additional genetic effects on intelligence and
		personality}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Molecular psychiatry}{}{}{}.
	\newblock
	\begin{APACrefDOI} \doi{10.1038/s41380-017-0005-1} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		...
		, Pratto, F.%
		, Henkel, K\BPBI E.%
		\BDBL {}Stewart, A\BPBI L.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2015}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {The nature of social dominance orientation: Theorizing
		and measuring preferences for intergroup inequality using the new {SDO}
		scale} {The nature of social dominance orientation: Theorizing and measuring
		preferences for intergroup inequality using the new {SDO} scale}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Journal of Personality and Social
		Psychology}{109}{}{1003--1028}.
	\newblock
	\begin{APACrefDOI} \doi{10.1037/pspi0000033} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\newblock
	\begin{APACrefDOI} \doi{10.1037/hea0000586} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Hu, L\BHBI t.%
		\BCBT {}\ \BBA {} Bentler, P\BPBI M.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{1999}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Cutoff Criteria for Fit Indexes in Covariance Structure
		Analysis: Conventional Criteria Versus New Alternatives} {Cutoff criteria for
		fit indexes in covariance structure analysis: Conventional criteria versus
		new alternatives}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Structural Equation Modeling}{6}{}{1--55}.
	\newblock
	\begin{APACrefDOI} \doi{10.1080/10705519909540118} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Jelen, T\BPBI G.%
		\BCBT {}\ \BBA {} Lockett, L\BPBI A.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2014}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Religion, Partisanship, and Attitudes Toward Science
		Policy} {Religion, partisanship, and attitudes toward science policy}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{SAGE Open}{4}{}{}.
	\newblock
	\begin{APACrefDOI} \doi{10.1177/2158244013518932} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2015}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Social dominance orientation and climate change denial:
		{The} role of dominance and system justification} {Social dominance
		orientation and climate change denial: {The} role of dominance and system
		justification}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Personality and Individual
		Differences}{86}{}{108--111}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.paid.2015.05.041} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		...
		, Cantal, C.%
		, Akrami, N.%
		\BCBL {}\ \BBA {} Milfont, T\BPBI L.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Denial of anthropogenic climate change: Social dominance
		orientation helps explain the conservative male effect in Brazil and Sweden}
	{Denial of anthropogenic climate change: Social dominance orientation helps
		explain the conservative male effect in brazil and sweden}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Personality and Individual Differences}{98}{}{184 --
		187}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.paid.2016.04.020} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2013}{}{}.
	\newblock
	\APACrefbtitle {Motivated numeracy and enlightened self-government} {Motivated
		numeracy and enlightened self-government}\ \APACbVolEdTR{}{\BTR{}\
		\BNUM~307}.
	\newblock
	\APACaddressInstitution{}{Yale University Law School, Public Law Working
		Paper}.
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2012}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {The polarizing impact of science literacy and numeracy
		on perceived climate change risks} {The polarizing impact of science literacy
		and numeracy on perceived climate change risks}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Nature Climate Change}{2}{}{732--735}.
	\newblock
	\begin{APACrefDOI} \doi{10.1038/NCLIMATE1547} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Karbach, J.%
		\BCBT {}\ \BBA {} Verhaeghen, P.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2014}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Making Working Memory Work: A Meta-Analysis of
		Executive-Control and Working Memory Training in Older Adults} {Making
		working memory work: A meta-analysis of executive-control and working memory
		training in older adults}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Psychological Science}{25}{}{2027-2037}.
	\newblock
	\begin{APACrefDOI} \doi{10.1177/0956797614548725} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		...
		, Schmelz, M.%
		, Call, J.%
		\BCBL {}\ \BBA {} Tomasello, M.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2015}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {The goggles experiment: can chimpanzees use
		self-experience to infer what a competitor can see?} {The goggles experiment:
		can chimpanzees use self-experience to infer what a competitor can
		see?}{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Animal Behaviour}{105}{}{211 -- 221}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.anbehav.2015.04.028} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2020}{}{}.
	\newblock
	\APACrefbtitle {Measuring model fit.} {Measuring model fit.}
	\newblock
	\begin{APACrefURL} \url{http://www.davidakenny.net/cm/fit.htm} \end{APACrefURL}
	\PrintBackRefs{\CurrentBib}
	...
	\unskip\
	\newblock
	\APACrefYearMonthDay{2012}{September}{}.
	\newblock
	\APACrefbtitle {{GMO} Opponents Are the Climate Skeptics of the Left
		(http://www.slate.com/articles/health\_and\_science/science/2012/09/\\are\_gmo\_foods\_safe\_opponents\_are\_skewing\_the\_science\_to\_scare\_people\_.html).}
	{{GMO} opponents are the climate skeptics of the left
		(http://www.slate.com/articles/health\_and\_science/science/2012/09/\\are\_gmo\_foods\_safe\_opponents\_are\_skewing\_the\_science\_to\_scare\_people\_.html).}
	\newblock
	\begin{APACrefURL}
		\url{http://www.slate.com/articles/health\_and\_science/science/2012/09/\\are\_gmo\_foods\_safe\_opponents\_are\_skewing\_the\_science\_to\_scare\_people\_.html}
	\end{APACrefURL}
	\newblock
	\APACrefnote{Accessed 29 September 2012}
	\PrintBackRefs{\CurrentBib}
	...
	\newblock
	{\BBOQ}\APACrefatitle {Toward a Measure of Patriotic and Nationalistic
		Attitudes} {Toward a measure of patriotic and nationalistic
		attitudes}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Political Psychology}{10}{}{257--274}.
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2018}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Cool dudes in {N}orway: climate change denial among
		conservative {N}orwegian men} {Cool dudes in {N}orway: climate change denial
		among conservative {N}orwegian men}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Environmental Sociology}{}{}{}.
	\newblock
	\begin{APACrefDOI} \doi{10.1080/23251042.2018.1488516} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2018}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Conservative Internationalism: An Overview}
	{Conservative internationalism: An overview}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Orbis}{62}{}{6 -- 21}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.orbis.2017.11.009} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2019}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Differential susceptibility to misleading flat earth
		arguments on {Y}ou{T}ube} {Differential susceptibility to misleading flat
		earth arguments on {Y}ou{T}ube}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Media Psychology}{}{}{1--30}.
	\newblock
	\begin{APACrefDOI} \doi{10.1080/15213269.2019.1669461} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\unskip\
	\newblock
	\APACrefYearMonthDay{2021{\protect \BCnt {1}}}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Climate change, disinformation, and how to combat it}
	{Climate change, disinformation, and how to combat it}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Annual Review of Public Health}{42}{}{1--21}.
	\newblock
	\begin{APACrefDOI} \doi{10.1146/annurev-publhealth-090419-102409}
	\end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\unskip\
	\newblock
	\APACrefYearMonthDay{2021{\protect \BCnt {2}}}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Conspiracist cognition: chaos, convenience, and cause
		for concern} {Conspiracist cognition: chaos, convenience, and cause for
		concern}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Journal for Cultural Research}{}{}{1--24}.
	\newblock
	\begin{APACrefDOI} \doi{10.1080/14797585.2021.1886423} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Motivated rejection of science} {Motivated rejection of
		science}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Current Directions in Psychological
		Science}{25}{}{217--222}.
	\newblock
	\begin{APACrefDOI} \doi{10.1177/0963721416654436} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2020}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Genesis or Evolution of Gender Differences?
		{W}orldview-Based Dilemmas in The Processing of Scientific Information}
	{Genesis or evolution of gender differences? {W}orldview-based dilemmas in
		the processing of scientific information}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Journal of Cognition}{3}{}{9}.
	\newblock
	\begin{APACrefDOI} \doi{10.5334/joc.99} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		...
		, Scheufele, D\BPBI A.%
		, Winneg, K\BPBI M.%
		\BCBL {}\ \BBA {} Jamieson, K\BPBI H.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Cross-pressuring conservative {C}atholics? {E}ffects of
		{P}ope {F}rancis' encyclical on the {U.S.} public opinion on climate change}
	{Cross-pressuring conservative {C}atholics? {E}ffects of {P}ope {F}rancis'
		encyclical on the {U.S.} public opinion on climate change}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Climatic Change}{139}{}{367--380}.
	\newblock
	\begin{APACrefDOI} \doi{10.1007/s10584-016-1821-z} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2008}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Communism, Universalism and Disinterestedness:
		{R}e-examining Contemporary Support among Academics for {M}erton’s
		Scientific Norms} {Communism, universalism and disinterestedness:
		{R}e-examining contemporary support among academics for {M}erton’s
		scientific norms}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Journal of Academic Ethics}{6}{}{67--78}.
	\newblock
	\begin{APACrefDOI} \doi{10.1007/s10805-008-9055-y} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2015}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Against Anthropocentrism. {N}on-human Otherness and the
		Post-human Project} {Against anthropocentrism. {N}on-human otherness and the
		post-human project}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{NanoEthics}{9}{}{75--84}.
	\newblock
	\begin{APACrefDOI} \doi{10.1007/s11569-015-0220-7} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2017}{}{}.
	\newblock
	\APACrefbtitle {Donald {T}rump has tweeted climate change skepticism 115 times.
		{H}ere's all of it.} {Donald {T}rump has tweeted climate change skepticism
		115 times. {H}ere's all of it.}
	\newblock
	\begin{APACrefURL}
		\url{https://www.vox.com/policy-and-politics/2017/6/1/15726472/trump-tweets-global-warming-paris-climate-agreement}
	\end{APACrefURL}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {There is no convincing evidence that working memory
		training is effective: {A} reply to {A}u et al. (2014) and {K}arbach and
		{V}erhaeghen (2014)} {There is no convincing evidence that working memory
		training is effective: {A} reply to {A}u et al. (2014) and {K}arbach and
		{V}erhaeghen (2014)}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Psychonomic Bulletin {\&} Review}{23}{}{324--330}.
	\newblock
	\begin{APACrefDOI} \doi{10.3758/s13423-015-0862-z} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\unskip\
	\newblock
	\APACrefYearMonthDay{1942}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {The Normative Structure of Science} {The normative
		structure of science}.{\BBCQ}
	\newblock
	\BIn{} N.~Storer\ (\BED), \APACrefbtitle {The sociology of science:
		{T}heoretical and empirical investigations} {The sociology of science:
		{T}heoretical and empirical investigations}\ (\BPGS\ 267--278).
	\newblock
	...
	\APACrefYearMonthDay{2013}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Environmental Consequences of the Desire to Dominate and
		Be Superior} {Environmental consequences of the desire to dominate and be
		superior}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Personality and Social Psychology
		Bulletin}{39}{}{1127--1138}.
	\newblock
	\begin{APACrefDOI} \doi{10.1177/0146167213490805} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2015}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Religion Does Matter for Climate Change Attitudes and
		Behavior} {Religion does matter for climate change attitudes and
		behavior}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{PLOS ONE}{10}{}{e0134868}.
	\newblock
	\begin{APACrefDOI} \doi{10.1371/journal.pone.0134868} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2002}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Four Assumptions Of Multiple Regression That Researchers
		Should Always Test} {Four assumptions of multiple regression that researchers
		should always test}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Practical Assessment, Research and Evaluation}{8}{2}{}.
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Pfattheicher, S.%
		\BCBT {}\ \BBA {} Schindler, S.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Misperceiving Bullshit as Profound Is Associated with
		Favorable Views of {C}ruz, {R}ubio, {T}rump and Conservatism} {Misperceiving
		bullshit as profound is associated with favorable views of {C}ruz, {R}ubio,
		{T}rump and conservatism}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{PLoS ONE}{11}{}{e0153419}.
	\newblock
	\begin{APACrefDOI} \doi{10.1371/journal.pone.0153419} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2015}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Meta-analysis of the heritability of human traits based
		on fifty years of twin studies} {Meta-analysis of the heritability of human
		traits based on fifty years of twin studies}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Nature Genetics}{47}{}{702--709}.
	\newblock
	\begin{APACrefDOI} \doi{10.1038/ng.3285} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		...
		, Vocino, A.%
		, Grimmer, M.%
		\BCBL {}\ \BBA {} Miles, M\BPBI P.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2014}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {The interrelationship between temporal and environmental
		orientation and pro-environmental consumer behaviour} {The interrelationship
		between temporal and environmental orientation and pro-environmental consumer
		behaviour}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{International journal of consumer
		studies}{38}{}{612--619}.
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Ranney, M\BPBI A.%
		, Munnich, E\BPBI L.%
		\BCBL {}\ \BBA {} Lamprey, L\BPBI N.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Increased wisdom from the ashes of ignorance and
		surprise: {N}umerically-driven inferencing, global warming, and other
		exemplar realms} {Increased wisdom from the ashes of ignorance and surprise:
		{N}umerically-driven inferencing, global warming, and other exemplar
		realms}.{\BBCQ}
	\newblock
	\BIn{} B\BPBI H.~Ross\ (\BED), \APACrefbtitle {The psychology of learning and
		motivation} {The psychology of learning and motivation}\ (\BVOL~65, \BPGS\
	129--182).
	\newblock
	\APACaddressPublisher{New York}{Elsevier}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/bs.plm.2016.03.005} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Rattan, A.%
		, Savani, K.%
		, Naidu, N\BPBI V\BPBI R.%
		\BCBL {}\ \BBA {} Dweck, C\BPBI S.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2012}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Can everyone become highly intelligent? {C}ultural
		differences in and societal consequences of beliefs about the universal
		potential for intelligence.} {Can everyone become highly intelligent?
		{C}ultural differences in and societal consequences of beliefs about the
		universal potential for intelligence.}{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Journal of Personality and Social
		Psychology}{103}{}{787--803}.
	\newblock
	\begin{APACrefDOI} \doi{10.1037/a0029263} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\newblock
	{\BBOQ}\APACrefatitle {Religiosity in youth: A personal control against deviant
		behavior1} {Religiosity in youth: A personal control against deviant
		behavior1}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Journal of Personality}{43}{}{136--155}.
	\newblock
	\begin{APACrefDOI} \doi{10.1111/j.1467-6494.1975.tb00577.x} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2013}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {When Truth Is Personally Inconvenient, Attitudes Change
		The Impact of Extreme Weather on Implicit Support for Green Politicians and
		Explicit Climate-Change Beliefs} {When truth is personally inconvenient,
		attitudes change the impact of extreme weather on implicit support for green
		politicians and explicit climate-change beliefs}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Psychological Science}{24}{}{2290--2296}.
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Sauce, B.%
		\BCBT {}\ \BBA {} Matzel, L\BPBI D.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2018}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {The paradox of intelligence: {H}eritability and
		malleability coexist in hidden gene-environment interplay.} {The paradox of
		intelligence: {H}eritability and malleability coexist in hidden
		gene-environment interplay.}{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Psychological Bulletin}{144}{}{26--47}.
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Srinivasan, K.%
		\BCBT {}\ \BBA {} Kasturirangan, R.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Political ecology, development, and human
		exceptionalism} {Political ecology, development, and human
		exceptionalism}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Geoforum}{75}{}{125 -- 128}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.geoforum.2016.07.011} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Are neoliberals more susceptible to bullshit?} {Are
		neoliberals more susceptible to bullshit?}{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Judgment and Decision Making}{11}{}{352--360}.
	\PrintBackRefs{\CurrentBib}
	...
	\unskip\
	\newblock
	\APACrefYearMonthDay{2016}{February}{}.
	\newblock
	\APACrefbtitle {Why in the world would rapper {B.o.B} think the {E}arth is
		flat? A quick science lesson.} {Why in the world would rapper {B.o.B} think
		the {E}arth is flat? a quick science lesson.}
	\newblock
	\begin{APACrefURL} \url{https://www.washingtonpost.com/news/
			\\answer-sheet/wp/2016/02/02/why-in-the-world-would-rapper-\\
			b-o-b-think-the-earth-is-flat-a-quick-science-lesson/} \end{APACrefURL}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2020}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Public Health and Online Misinformation: Challenges and
		Recommendations} {Public health and online misinformation: Challenges and
		recommendations}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Annual Review of Public Health}{41}{}{}.
	\newblock
	\begin{APACrefDOI} \doi{10.1146/annurev-publhealth-040119-094127}
	\end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Todorov, A.%
		\BCBT {}\ \BBA {} Mandisodza, A\BPBI N.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2004}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Public opinion on foreign policy: The multilateral
		public that perceives itself as unilateral} {Public opinion on foreign
		policy: The multilateral public that perceives itself as unilateral}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Public Opinion Quarterly}{68}{}{323-348}.
	\newblock
	\begin{APACrefDOI} \doi{10.1093/poq/nfh036} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2017}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Climate patriots? {C}oncern over climate change and
		other environmental issues in {A}ustralia} {Climate patriots? {C}oncern over
		climate change and other environmental issues in {A}ustralia}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Public Understanding of Science}{26}{}{738-752}.
	\newblock
	\begin{APACrefDOI} \doi{10.1177/0963662515618553} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2016}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Is ideology the enemy of inquiry? {E}xamining the link
		between political orientation and lack of interest in novel data} {Is
		ideology the enemy of inquiry? {E}xamining the link between political
		orientation and lack of interest in novel data}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Journal of Research in Personality}{63}{}{123 - 132}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.jrp.2016.06.018} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2007}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Spontaneous Altruism by Chimpanzees and Young Children}
	{Spontaneous altruism by chimpanzees and young children}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{PLOS Biology}{5}{}{e184}.
	\newblock
	\begin{APACrefDOI} \doi{10.1371/journal.pbio.0050184} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\begin{APACrefauthors}%
		Warneken, F.%
		\BCBT {}\ \BBA {} Tomasello, M.%
	\end{APACrefauthors}%
	\unskip\
	\newblock
	\APACrefYearMonthDay{2006}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Altruistic Helping in Human Infants and Young
		Chimpanzees} {Altruistic helping in human infants and young
		chimpanzees}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Science}{311}{}{1301--1303}.
	\newblock
	\begin{APACrefDOI} \doi{10.1126/science.1121448} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2011}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Scepticism and uncertainty about climate change:
		{D}imensions, determinants and change over time} {Scepticism and uncertainty
		about climate change: {D}imensions, determinants and change over
		time}.{\BBCQ}
	\newblock
	\APACjournalVolNumPages{Global Environmental Change}{21}{}{690 -- 700}.
	\newblock
	\begin{APACrefDOI} \doi{10.1016/j.gloenvcha.2011.01.016} \end{APACrefDOI}
	\PrintBackRefs{\CurrentBib}
	...
	\APACrefYearMonthDay{2017}{}{}.
	\newblock
	{\BBOQ}\APACrefatitle {Paranoid egalitarian meliorism: An account of bias in
		the social sciences} {Paranoid egalitarian meliorism: An account of bias in
		the social sciences}.{\BBCQ}
	\newblock
	\BIn{} J\BPBI T.~Crawford\ \BBA {} L.~Jussim\ (\BEDS), \APACrefbtitle {Politics
		of social psychology} {Politics of social psychology}\ (\BPGS\ 203--219).
	\newblock
