...
\begin{longtable}{p{.2\linewidth} p{.8\linewidth}} %tab:items
	...
	\hline
	\nopagebreak
	\emph{IQGen} & When people differ in intelligence, it is mostly due to differences in their genetic endowment (R) \\
	
	\emph{IQAdopt} & When a child is adopted into a new family, its intelligence does not depend on the intelligence of its birth parents \\
	
	\emph{IQEd} & Intelligence is not inherited, it is acquired through education \\
	
	\emph{IQUpbring} & A person's upbringing is more important to their intelligence than their genetic inheritance \\
	
	\emph{IQTwins} & Identical twins separated shortly after birth and reared in different family environments will end up having similar intelligence (R) \\
	
	\emph{IQParents} & If you know the intelligence of parents, you can make a good guess about the intelligence of   their children even if the children have been brought up by others (R) \\
	
	\emph{IQStim} & With a rich stimulating environment every healthy child can grow up to be smart enough to learn any profession \\
